...
func httpTestsBitcoinType(t *testing.T, ts *httptest.Server) {
	tests := []struct {
		...
		},
		{
			...
			contentType: "application/json; charset=utf-8",
			body: []string{
				`[{"txid":"3d90d15ed026dc45e19ffb52875ed18fa9e8012ad123d7f7212176e2b0ebdb71","vout":0,"value":"118641975500","height":225494,"confirmations":1,"address":"2N6utyMZfPNUb1Bk8oz7p2JqJrXkq83gegu","path":"m/49'/1'/33'/1/3","scriptPubKey":"a91495e9fbe306449c991d314afe3c3567d5bf78efd287"}]`,
			},
		},
		{
			name:        "apiSendTx",
